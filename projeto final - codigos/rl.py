...
classificador = LogisticRegression(solver = 'lbfgs') # solver(lbfgs*, defoult)  => usado para otimizacao dos dados 'solucionador'.
...
plt.show()
tfim=time.time()
print('todas predições: ', round((tfim - tini), 2) / 60, 'min')
